                  ...
                  <ClerkLoaded>
                    ...
                    (<div className="flex items-center space-x-2">
                      ...
                      {user?.passkeys.length === 0 && (
                        <button onClick={createClerkPasskey} className="bg-white hover:bg-blue-700 hover:text-white animate-pulse text-blue-500 font-bold py-2 px-4 rounded border-blue-300">
                          Create Passkey
                        </button>
                      )}
